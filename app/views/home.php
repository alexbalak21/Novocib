...
<meta name="description"
    content="Novocib is a biotechnology company focused on nucleotides metabolism. Company has developed a range of innovative products and services for nucleotide analysis in cells, food, feed ingredients.">
...
<main id="main-content">
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-center">
            <div class="searchbar">
                <input id="searchInput" class="search_input" type="text" name="search" aria-label="Search the website" placeholder="Search...">
    ...
    <section class="container mt-5" content="section containing the presentation of novocib services">
        <div class="row justify-content-center">
            <div class="col-lg-4 d-flex justify-content-center">
                <div class="box">
                    ...
                    <div class="card-content">
                        <ul>
                            <li>Whole nucleotides spectra (heterocyclic bases, nucleosides and nucleotides, nucleic
                                acids
                                RNA and DNA);</li>
            ...
            <div class="col-lg-4 d-flex justify-content-center">
                <div class="box">
                    <a href="/convenient-assay-kits"><img src="/app/img/assay-kit-photo.jpg"
                            alt="Four labeled reagent tubes—Factor 1, Factor 2, IMPDH, and HPRT—arranged in front of a multiwell assay plate in a molecular biology laboratory" page="Freshness Assay Kits page"
                            aria-label="Go to Freshness Assay Kits page"
                            title="Go to Freshness Assay Kits page"></a>
                    <div class="text-center"><a href="/convenient-assay-kits">PRECICE<sup>®</sup> One-step Kits</a>
                    </div>
                    <div class="card-content">
                        <ul>
                            <li>Include precise amounts of enzymes, buffers, cofactors and substrates at optimal
                                concentrations;</li>
                            <li>96-well microplate form;</li>
                            <li>Convenient, saves time and preempts possible errors.</li>
                        </ul>
                    </div>
                    <div class="text-center my-4" title="Freshness Assay Kits"><a href="/convenient-assay-kits"
                            aria-label="Go to Freshness Assay Kits page"
            ...
            <div class="col-lg-4 d-flex justify-content-center">
                <div class="box">
                    <a href="/active-purified-enzymes"><img src="/app/img/molecular-structure-card.jpg"
                            alt="Molecular visualization showing a ligand bound inside a protein's surface cavity, illustrating a protein-ligand interaction." page="Active purified enzymes page"
                            aria-label="Go to Active purified enzymes page"
                            title="Active purified enzymes"></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-container col-lg-7 d-flex justify-content-center align-items-center">
                    <div>
                        <p>
                            Novocib is a biotechnology company created in 2005 and focused on nucleotides metabolism.
                            Company has developed a range of innovative products and services for nucleotide analysis in
                            cells, food, feed ingredients:
                        </p>
                        <ul>
                            <li>
                                Analytical service for whole spectra of nucleotides (heterocyclic bases, nucleosides,
                        ...
                        <div class="text-center mb-4"><a href="/news" class="btn btn-primary"><i
                                    class="fa-solid fa-newspaper"></i> &nbsp; News</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <article class="awards container mt-4 mb-4 text-center">
        ...
        <p class="mb-5">NOVOCIB SAS is french biotechnology company founded in 2005, a double Laureate of Concours
            National
            pour la Création d'Entreprises de Technologie Innovante (I-LAB) in 2003 and 2005 and “Tremplin Entreprises”
            organized by French Senate (2004). <br> Since its creation in 2005, the company has developed multiple
            innovative solutions helping scientists and engineers worldwide to quantify nucleotides in their biological
            samples.</p>
        <div class="row justify-content-center">
            ...
            <div class="award col-lg-3 col-10">
                ...
                <p>
                    I-Lab is the yearly innovation contest organized by the French Ministry of Research and Innovation
                    in
                    partnership with the French Public Investment Bank BpiFrance #France2030 to recognize and
                    financially
                    support the best innovative deeptech companies.
                </p>
                <div class="text-center my-4">
                    <a title="i-lab awards" class="btn btn-outline-primary" target="_blank"
            ...
            <div class="award col-lg-3 col-10">
                ...
                <p>
                    This excellence competition is a financial support initiative funded by the France 2030 plan, which
                    aims
                ...
                <div class="text-center my-4">
                    <a class="btn btn-outline-primary" target="_blank" title="french senate"
            ...
            <div class="award col-lg-3 col-10">
                ...
                <p>
                    The "Trophées Femmes en or" (Women in Gold Awards) are a prize created in 1993 by Framboise Holtz
                    and
                    Jean-Louis Sevez to reward women whose success in the past year, whether it be a culmination or a
                    step,
                    serves as an example and a source of inspiration for all.
                </p>
                <div class="text-center my-4">
                    <a class="btn btn-outline-primary" target="_blank" title="facebook"
                        href="https://www.facebook.com/femmesenor/">Go to Website</a>
                </div>
            </div>
        </div>
    </article>
                    ...
                    <div class="card-img">
                        <a href="https://www.business-angels.info/">
                            <img src="/app/img/xmp.png" alt="xmp investors logo"
                                title="Xmp Investors Business Angels" />
                ...
                <div class="card">
                    <div class="card-img">
                        <a href=" https://www.pfinouvellesvagues.com/">
                            <img src="/app/img/nouvelle-vagues.png" alt="nouvelle-vagues logo"
                                title="Innovation platform for seafood" />
