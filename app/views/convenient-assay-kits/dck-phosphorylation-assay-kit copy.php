...
<section class="container mt-5">
    <h1 class="h2 underlinedTitle right"><span class="underlined novoblue right">PRECICE<sup>®</sup> DCK Phosphorylation Assay Kit</span></h1>
    <p class="lead mb-4 text-center">A microplate based spectrophotometric assay designed to assess the phosphorylation of novel ribo- and deoxyribonucleoside analogues by human recombinant deoxycytidine kinase</p>
    <div class="text-center mb-5">
        <span class="badge bg-primary me-2">Includes active human deoxycytidine kinase enzyme</span>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 text-center">
            <figure class="col-xl-8 col-10 mx-auto mb-4">
                <img class="img-fluid" src="/app/img/dck_assay_kit.jpg" alt="dCK phosphorylation kit composition" title="Composition of the dCK Phosphorylation Assay Kit" />
            </figure>
            <figure class="border rounded mt-5">
                <img class="w-100" src="/app/img/dCK-phosphorylation-kit.png" alt="dCK phosphorylation kit reaction schema" title="Enzymatic principle of PRECICE® dCK Phosphorylation Assay Kit" />
                <figcaption class="text-muted my-1">Figure 1. Enzymatic principle of PRECICE<sup>®</sup> dCK Phosphorylation Assay Kit</figcaption>
            </figure>
            <h4 class="novo-blue mt-2">PRECICE<sup>®</sup> dCK Phosphorylation Assay Kit</h4>
            <h5>Ref. #K0307-01</h5>
        </div>
        ...
        <div class="col-12">
            <h4 class="novo-blue">Enzyme and Assay Validation</h4>
...
<div class="bg-light mt-5 pt-1 pb-1">
    <div class="container">
