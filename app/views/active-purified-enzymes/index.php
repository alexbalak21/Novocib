    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="purine w-100">
                <tr>
                    <td class="col-2">
                        <h5><a href="/active-purified-enzymes/human-recombinant-impdh">IMPDH <i class="fa-solid fa-arrow-up-right-from-square"></i></a></h5>
                    </td>
                    <td class="col-5">Inosine 5'-monophosphate dehydrogenase type 2 (IMPDH 2, E.C.1.1.1.205)</td>
