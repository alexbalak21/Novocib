...
<h2 class="underlinedTitle center"><span class="underlined novoblue center">PRECICE<sup>®</sup> Nucleotides Assay Kits</span></h2>
<div class="row">
<div class="col-lg-4">
...
<li>R²=0.88 found between H-value measured with <strong class="novo-blue">PRECICE<sup>®</sup> Nucleotides Assay Kit</strong> and TMA/ABVT in whiting fillets (11 samples)</li>
</ul>
...
<p>Download <a target="_blank" href="/app/documents/PRECICE Nucleotides Assay Kit K0700-004.pdf">"PRECICE<sup>®</sup> Nucleotides Assay Kit"</a> <strong>User Manual</strong> for cuvette spectrophotometer.</p>
<p>Download <a target="_blank" href="/app/documents/PRECICE Nucleotides Assay Kit K0700-003.pdf">"PRECICE<sup>®</sup> Nucleotides Assay Kit"</a> <strong>User Manual</strong> for plate reader.</p>
</div>
</main>
CONTENT;
