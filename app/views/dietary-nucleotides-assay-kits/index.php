    ...
    <div class="kit row align-items-center">
        ...
        <div class="col-8">
            <p>
                ...
                <br><br>
                NOVOCIB'S <a href="/freshness-assay-kits/freshness-assay-kit">PRECICE<sup>®</sup> IMP Assay Kit</a> is a colorimetric assay for enzymatic determination of IMP in fishmeal samples.
            </p>
        </div>
    </div>
    <div class="kit row align-items-center">
        ...
        <div class="col-8">
            <p>
                ...
                <br><br>
                <a href="/active-purified-enzymes/cnII">PRECICE<sup>®</sup> 5'AMP and 5'IMP Assay Kit</a> colorimetric assay for enzymatic determination of 5'IMP and 5'AMP in yeast samples.
            </p>
        </div>
    </div>
</section>